...
// Nested API
std::string DrawingCanvas::svg(void)
{
...
void DrawingCanvas::show(const char* filename){
	...
	//std::ofstream svgfile = std::cout;
	if (1){
		std::cout << _header.str() << std::endl;
		...
		//
		/////////////////////////////////////////////////////
		std::cout << " <g id=\"bottomLayer" << "\" class=\"layer\" >\n";
		std::cout << _bottomLayer.str() << std::endl;
		std::cout << " </g>\n";
